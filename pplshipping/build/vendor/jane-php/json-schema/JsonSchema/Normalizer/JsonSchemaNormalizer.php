...
class JsonSchemaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \PPLShipping\Jane\Component\JsonSchema\JsonSchema\Model\JsonSchema;
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLShipping\Jane\Component\JsonSchema\JsonSchema\Model\JsonSchema();
        ...
        if (\array_key_exists('definitions', $data) && $data['definitions'] !== null) {
            ...
            foreach ($data['definitions'] as $key => $value) {
                $value_1 = $value;
                if (\is_array($value)) {
                    $value_1 = $this->denormalizer->denormalize($value, 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('dependencies', $data) && $data['dependencies'] !== null) {
            ...
            foreach ($data['dependencies'] as $key_1 => $value_2) {
                $value_3 = $value_2;
                if (\is_array($value_2)) {
                    $value_3 = $this->denormalizer->denormalize($value_2, 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('additionalItems', $data) && $data['additionalItems'] !== null) {
            ...
            if (\is_array($data['additionalItems'])) {
                $value_5 = $this->denormalizer->denormalize($data['additionalItems'], 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('unevaluatedItems', $data) && $data['unevaluatedItems'] !== null) {
            ...
            if (\is_array($data['unevaluatedItems'])) {
                $value_6 = $this->denormalizer->denormalize($data['unevaluatedItems'], 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('items', $data) && $data['items'] !== null) {
            ...
            if (\is_array($data['items'])) {
                $value_7 = $this->denormalizer->denormalize($data['items'], 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
                ...
                foreach ($data['items'] as $value_8) {
                    $value_9 = $value_8;
                    if (\is_array($value_8)) {
                        $value_9 = $this->denormalizer->denormalize($value_8, 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('contains', $data) && $data['contains'] !== null) {
            ...
            if (\is_array($data['contains'])) {
                $value_10 = $this->denormalizer->denormalize($data['contains'], 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('additionalProperties', $data) && $data['additionalProperties'] !== null) {
            ...
            if (\is_array($data['additionalProperties'])) {
                $value_11 = $this->denormalizer->denormalize($data['additionalProperties'], 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('unevaluatedProperties', $data) && $data['unevaluatedProperties'] !== null) {
            ...
            foreach ($data['unevaluatedProperties'] as $key_2 => $value_12) {
                ...
                if (\is_array($value_12)) {
                    $value_13 = $this->denormalizer->denormalize($value_12, 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('properties', $data) && $data['properties'] !== null) {
            ...
            foreach ($data['properties'] as $key_3 => $value_14) {
                ...
                if (\is_array($value_14)) {
                    $value_15 = $this->denormalizer->denormalize($value_14, 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('patternProperties', $data) && $data['patternProperties'] !== null) {
            ...
            foreach ($data['patternProperties'] as $key_4 => $value_16) {
                ...
                if (\is_array($value_16)) {
                    $value_17 = $this->denormalizer->denormalize($value_16, 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('dependentSchemas', $data) && $data['dependentSchemas'] !== null) {
            ...
            foreach ($data['dependentSchemas'] as $key_5 => $value_18) {
                ...
                if (\is_array($value_18)) {
                    $value_19 = $this->denormalizer->denormalize($value_18, 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('propertyNames', $data) && $data['propertyNames'] !== null) {
            ...
            if (\is_array($data['propertyNames'])) {
                $value_20 = $this->denormalizer->denormalize($data['propertyNames'], 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('if', $data) && $data['if'] !== null) {
            $value_21 = $data['if'];
            if (\is_array($data['if'])) {
                $value_21 = $this->denormalizer->denormalize($data['if'], 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('then', $data) && $data['then'] !== null) {
            ...
            if (\is_array($data['then'])) {
                $value_22 = $this->denormalizer->denormalize($data['then'], 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('else', $data) && $data['else'] !== null) {
            ...
            if (\is_array($data['else'])) {
                $value_23 = $this->denormalizer->denormalize($data['else'], 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('allOf', $data) && $data['allOf'] !== null) {
            ...
            foreach ($data['allOf'] as $value_24) {
                ...
                if (\is_array($value_24)) {
                    $value_25 = $this->denormalizer->denormalize($value_24, 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('anyOf', $data) && $data['anyOf'] !== null) {
            ...
            foreach ($data['anyOf'] as $value_26) {
                ...
                if (\is_array($value_26)) {
                    $value_27 = $this->denormalizer->denormalize($value_26, 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('oneOf', $data) && $data['oneOf'] !== null) {
            ...
            foreach ($data['oneOf'] as $value_28) {
                ...
                if (\is_array($value_28)) {
                    $value_29 = $this->denormalizer->denormalize($value_28, 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('not', $data) && $data['not'] !== null) {
            ...
            if (\is_array($data['not'])) {
                $value_30 = $this->denormalizer->denormalize($data['not'], 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('contentSchema', $data) && $data['contentSchema'] !== null) {
            ...
            if (\is_array($data['contentSchema'])) {
                $value_31 = $this->denormalizer->denormalize($data['contentSchema'], 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
        ...
        if (\array_key_exists('$defs', $data) && $data['$defs'] !== null) {
            ...
            foreach ($data['$defs'] as $key_7 => $value_33) {
                ...
                if (\is_array($value_33)) {
                    $value_34 = $this->denormalizer->denormalize($value_33, 'PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema', 'json', $context);
    ...
    {
        return array('PPLShipping\\Jane\\Component\\JsonSchema\\JsonSchema\\Model\\JsonSchema' => \false);
    }
}
