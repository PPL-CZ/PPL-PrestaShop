...
use PPLShipping\PhpCsFixer\Console\Command\FixCommand;
use PPLShipping\PhpCsFixer\ToolInfo;
use PPLShipping\PhpParser\PrettyPrinterAbstract;
use PPLShipping\Symfony\Component\Console\Input\ArrayInput;
use PPLShipping\Symfony\Component\Console\Output\NullOutput;
...
EOH
        ...
        if (\version_compare(\PPLShipping\PhpCsFixer\Console\Application::VERSION, '3.0.0', '>=')) {
            $rules['yoda_style'] = \false;
        } elseif (\version_compare(\PPLShipping\PhpCsFixer\Console\Application::VERSION, '2.6.0', '>=')) {
