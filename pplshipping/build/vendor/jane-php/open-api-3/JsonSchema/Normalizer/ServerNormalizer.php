...
class ServerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \PPLShipping\Jane\Component\OpenApi3\JsonSchema\Model\Server;
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLShipping\Jane\Component\OpenApi3\JsonSchema\Model\Server();
        ...
        if (\array_key_exists('variables', $data) && $data['variables'] !== null) {
            ...
            foreach ($data['variables'] as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\ServerVariable', 'json', $context);
            }
