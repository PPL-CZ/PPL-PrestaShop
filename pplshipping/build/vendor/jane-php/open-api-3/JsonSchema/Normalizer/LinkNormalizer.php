...
class LinkNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \PPLShipping\Jane\Component\OpenApi3\JsonSchema\Model\Link;
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLShipping\Jane\Component\OpenApi3\JsonSchema\Model\Link();
        ...
        if (\array_key_exists('server', $data) && $data['server'] !== null) {
            $object->setServer($this->denormalizer->denormalize($data['server'], 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\Server', 'json', $context));
            unset($data['server']);
