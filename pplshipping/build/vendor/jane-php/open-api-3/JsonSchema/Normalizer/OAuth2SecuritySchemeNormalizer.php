...
class OAuth2SecuritySchemeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \PPLShipping\Jane\Component\OpenApi3\JsonSchema\Model\OAuth2SecurityScheme;
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLShipping\Jane\Component\OpenApi3\JsonSchema\Model\OAuth2SecurityScheme();
        ...
        if (\array_key_exists('flows', $data) && $data['flows'] !== null) {
            $object->setFlows($this->denormalizer->denormalize($data['flows'], 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\OAuthFlows', 'json', $context));
            unset($data['flows']);
