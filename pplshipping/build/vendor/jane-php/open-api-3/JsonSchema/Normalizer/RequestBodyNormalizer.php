...
class RequestBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \PPLShipping\Jane\Component\OpenApi3\JsonSchema\Model\RequestBody;
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLShipping\Jane\Component\OpenApi3\JsonSchema\Model\RequestBody();
        ...
        if (\array_key_exists('content', $data) && $data['content'] !== null) {
            ...
            foreach ($data['content'] as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\MediaType', 'json', $context);
            }
