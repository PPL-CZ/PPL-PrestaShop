...
class ComponentsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \PPLShipping\Jane\Component\OpenApi3\JsonSchema\Model\Components;
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLShipping\Jane\Component\OpenApi3\JsonSchema\Model\Components();
            ...
            foreach ($data['schemas'] as $key => $value) {
                if (\preg_match('/^[a-zA-Z0-9\\.\\-_]+$/', (string) $key) && isset($value)) {
                    ...
                    if (\is_array($value) and isset($value['$ref'])) {
                        ...
                        $value_1 = $this->denormalizer->denormalize($value, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\Schema', 'json', $context);
                    }
                    $values[$key] = $value_1;
                    continue;
                }
            ...
            foreach ($data['responses'] as $key_1 => $value_2) {
                if (\preg_match('/^[a-zA-Z0-9\\.\\-_]+$/', (string) $key_1) && isset($value_2)) {
                    ...
                    if (\is_array($value_2) and isset($value_2['$ref'])) {
                        $value_3 = $this->denormalizer->denormalize($value_2, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\Reference', 'json', $context);
                    } elseif (\is_array($value_2) and isset($value_2['description'])) {
                        $value_3 = $this->denormalizer->denormalize($value_2, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\Response', 'json', $context);
                    }
            ...
            foreach ($data['parameters'] as $key_2 => $value_4) {
                if (\preg_match('/^[a-zA-Z0-9\\.\\-_]+$/', (string) $key_2) && isset($value_4)) {
                    ...
                    if (\is_array($value_4) and isset($value_4['$ref'])) {
                        $value_5 = $this->denormalizer->denormalize($value_4, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\Reference', 'json', $context);
                    } elseif (\is_array($value_4) and isset($value_4['name']) and isset($value_4['in'])) {
                        $value_5 = $this->denormalizer->denormalize($value_4, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\Parameter', 'json', $context);
                    }
            ...
            foreach ($data['examples'] as $key_3 => $value_6) {
                if (\preg_match('/^[a-zA-Z0-9\\.\\-_]+$/', (string) $key_3) && isset($value_6)) {
                    ...
                    if (\is_array($value_6) and isset($value_6['$ref'])) {
                        $value_7 = $this->denormalizer->denormalize($value_6, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\Reference', 'json', $context);
                    } elseif (\is_array($value_6)) {
                        $value_7 = $this->denormalizer->denormalize($value_6, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\Example', 'json', $context);
                    }
            ...
            foreach ($data['requestBodies'] as $key_4 => $value_8) {
                if (\preg_match('/^[a-zA-Z0-9\\.\\-_]+$/', (string) $key_4) && isset($value_8)) {
                    ...
                    if (\is_array($value_8) and isset($value_8['$ref'])) {
                        $value_9 = $this->denormalizer->denormalize($value_8, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\Reference', 'json', $context);
                    } elseif (\is_array($value_8) and isset($value_8['content'])) {
                        $value_9 = $this->denormalizer->denormalize($value_8, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\RequestBody', 'json', $context);
                    }
            ...
            foreach ($data['headers'] as $key_5 => $value_10) {
                if (\preg_match('/^[a-zA-Z0-9\\.\\-_]+$/', (string) $key_5) && isset($value_10)) {
                    ...
                    if (\is_array($value_10) and isset($value_10['$ref'])) {
                        ...
                        $value_11 = $this->denormalizer->denormalize($value_10, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\Header', 'json', $context);
                    }
            ...
            foreach ($data['securitySchemes'] as $key_6 => $value_12) {
                if (\preg_match('/^[a-zA-Z0-9\\.\\-_]+$/', (string) $key_6) && isset($value_12)) {
                    ...
                    if (\is_array($value_12) and isset($value_12['$ref'])) {
                        $value_13 = $this->denormalizer->denormalize($value_12, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\Reference', 'json', $context);
                        ...
                        $value_13 = $this->denormalizer->denormalize($value_12, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\APIKeySecurityScheme', 'json', $context);
                    } elseif (\is_array($value_12) and isset($value_12['scheme']) and (isset($value_12['type']) and $value_12['type'] == 'http')) {
                        $value_13 = $this->denormalizer->denormalize($value_12, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\HTTPSecurityScheme', 'json', $context);
                    } elseif (\is_array($value_12) and (isset($value_12['type']) and $value_12['type'] == 'oauth2') and isset($value_12['flows'])) {
                        $value_13 = $this->denormalizer->denormalize($value_12, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\OAuth2SecurityScheme', 'json', $context);
                    } elseif (\is_array($value_12) and (isset($value_12['type']) and $value_12['type'] == 'openIdConnect') and isset($value_12['openIdConnectUrl'])) {
                        $value_13 = $this->denormalizer->denormalize($value_12, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\OpenIdConnectSecurityScheme', 'json', $context);
                    }
            ...
            foreach ($data['links'] as $key_7 => $value_14) {
                if (\preg_match('/^[a-zA-Z0-9\\.\\-_]+$/', (string) $key_7) && isset($value_14)) {
                    ...
                    if (\is_array($value_14) and isset($value_14['$ref'])) {
                        $value_15 = $this->denormalizer->denormalize($value_14, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\Reference', 'json', $context);
                    } elseif (\is_array($value_14)) {
                        $value_15 = $this->denormalizer->denormalize($value_14, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\Link', 'json', $context);
                    }
            ...
            foreach ($data['callbacks'] as $key_8 => $value_16) {
                if (\preg_match('/^[a-zA-Z0-9\\.\\-_]+$/', (string) $key_8) && isset($value_16)) {
                    ...
                    if (\is_array($value_16) and isset($value_16['$ref'])) {
                        $value_17 = $this->denormalizer->denormalize($value_16, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\Reference', 'json', $context);
