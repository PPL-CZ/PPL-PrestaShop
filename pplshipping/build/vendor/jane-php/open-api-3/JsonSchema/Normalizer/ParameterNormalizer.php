...
class ParameterNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \PPLShipping\Jane\Component\OpenApi3\JsonSchema\Model\Parameter;
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \PPLShipping\Jane\Component\OpenApi3\JsonSchema\Model\Parameter();
        ...
        if (\array_key_exists('content', $data) && $data['content'] !== null) {
            ...
            foreach ($data['content'] as $key => $value_1) {
                $values[$key] = $this->denormalizer->denormalize($value_1, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\MediaType', 'json', $context);
            }
        ...
        if (\array_key_exists('examples', $data) && $data['examples'] !== null) {
            ...
            foreach ($data['examples'] as $key_1 => $value_2) {
                ...
                if (\is_array($value_2) and isset($value_2['$ref'])) {
                    ...
                    $value_3 = $this->denormalizer->denormalize($value_2, 'PPLShipping\\Jane\\Component\\OpenApi3\\JsonSchema\\Model\\Example', 'json', $context);
                }
