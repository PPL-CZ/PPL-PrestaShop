...
use PPLShipping\GuzzleHttp\Cookie\CookieJar;
use PPLShipping\GuzzleHttp\Exception\GuzzleException;
use PPLShipping\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \PPLShipping\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
