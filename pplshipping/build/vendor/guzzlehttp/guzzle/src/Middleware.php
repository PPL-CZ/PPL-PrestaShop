...
namespace PPLShipping\GuzzleHttp;

use PPLShipping\GuzzleHttp\Cookie\CookieJarInterface;
...
use PPLShipping\Psr\Log\LoggerInterface;
/**
        ...
        return static function (callable $handler) : callable {
            return static function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('PPLShipping\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
