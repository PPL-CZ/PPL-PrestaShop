 ...
 */
namespace PPLShipping\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'PPLShipping\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'PPLShipping\\Mes\\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'PPLShipping\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'PPLShipping\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'PPLShipping\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'PPLShipping\\Mon\\1'],
        // Default rule
        ['/s$/i', ''],
    ];
