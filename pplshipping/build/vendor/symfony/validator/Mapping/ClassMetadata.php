...
use PPLShipping\Symfony\Component\Validator\Constraints\Cascade;
...
use PPLShipping\Symfony\Component\Validator\Constraints\Traverse;
...
use PPLShipping\Symfony\Component\Validator\Exception\GroupDefinitionException;
/**
...
class ClassMetadata extends GenericMetadata implements ClassMetadataInterface
{
    ...
    public function setGroupSequenceProvider(bool $active)
    {
        ...
        if (!$this->getReflectionClass()->implementsInterface('PPLShipping\\Symfony\\Component\\Validator\\GroupSequenceProviderInterface')) {
