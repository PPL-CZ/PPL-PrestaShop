...
namespace PPLShipping\Http\Discovery\Composer;

use PPLShipping\Composer\Composer;
use PPLShipping\Composer\DependencyResolver\Pool;
use PPLShipping\Composer\EventDispatcher\EventSubscriberInterface;
use PPLShipping\Composer\Factory;
use PPLShipping\Composer\Installer;
use PPLShipping\Composer\IO\IOInterface;
use PPLShipping\Composer\Json\JsonFile;
use PPLShipping\Composer\Json\JsonManipulator;
use PPLShipping\Composer\Package\Locker;
use PPLShipping\Composer\Package\Version\VersionParser;
use PPLShipping\Composer\Package\Version\VersionSelector;
use PPLShipping\Composer\Plugin\PluginInterface;
use PPLShipping\Composer\Repository\InstalledRepositoryInterface;
use PPLShipping\Composer\Repository\RepositorySet;
use PPLShipping\Composer\Script\Event;
use PPLShipping\Composer\Script\ScriptEvents;
use PPLShipping\Composer\Util\Filesystem;
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = ['php-http/async-client-implementation' => ['PPLShipping\\Http\\Client\\HttpAsyncClient'], 'php-http/client-implementation' => ['PPLShipping\\Http\\Client\\HttpClient'], 'psr/http-client-implementation' => ['PPLShipping\\Psr\\Http\\Client\\ClientInterface'], 'psr/http-factory-implementation' => ['PPLShipping\\Psr\\Http\\Message\\RequestFactoryInterface', 'PPLShipping\\Psr\\Http\\Message\\ResponseFactoryInterface', 'PPLShipping\\Psr\\Http\\Message\\ServerRequestFactoryInterface', 'PPLShipping\\Psr\\Http\\Message\\StreamFactoryInterface', 'PPLShipping\\Psr\\Http\\Message\\UploadedFileFactoryInterface', 'PPLShipping\\Psr\\Http\\Message\\UriFactoryInterface']];
    ...
    public function getMissingRequires(InstalledRepositoryInterface $repo, array $requires, bool $isProject, array $pinnedAbstractions) : array
    {
        ...
        if (ClassDiscovery::safeClassExists(\PPLShipping\Phalcon\Http\Message\RequestFactory::class, \false)) {
