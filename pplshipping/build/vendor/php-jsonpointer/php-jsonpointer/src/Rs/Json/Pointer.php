...
namespace PPLShipping\Rs\Json;

use PPLShipping\Rs\Json\Pointer\InvalidJsonException;
use PPLShipping\Rs\Json\Pointer\InvalidPointerException;
use PPLShipping\Rs\Json\Pointer\NonexistentValueReferencedException;
use PPLShipping\Rs\Json\Pointer\NonWalkableJsonException;
class Pointer
{
    const POINTER_CHAR = '/';
