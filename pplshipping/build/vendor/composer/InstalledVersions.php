 ...
 */
namespace PPLShipping\Composer;

use PPLShipping\Composer\Autoload\ClassLoader;
use PPLShipping\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('PPLShipping\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
