...
namespace PPLShipping\Doctrine\Inflector\Rules\English;

use PPLShipping\Doctrine\Inflector\Rules\Pattern;
use PPLShipping\Doctrine\Inflector\Rules\Substitution;
use PPLShipping\Doctrine\Inflector\Rules\Transformation;
use PPLShipping\Doctrine\Inflector\Rules\Word;
class Inflectible
{
    /** @return Transformation[] */
    public static function getSingular() : iterable
    {
        (yield new Transformation(new Pattern('(s)tatuses$'), 'PPLShipping\\1\\2tatus'));
        (yield new Transformation(new Pattern('(s)tatus$'), 'PPLShipping\\1\\2tatus'));
        (yield new Transformation(new Pattern('(c)ampus$'), 'PPLShipping\\1\\2ampus'));
        (yield new Transformation(new Pattern('^(.*)(menu)s$'), 'PPLShipping\\1\\2'));
        ...
        (yield new Transformation(new Pattern('(m)ovies$'), 'PPLShipping\\1\\2ovie'));
        (yield new Transformation(new Pattern('(s)eries$'), 'PPLShipping\\1\\2eries'));
        ...
        (yield new Transformation(new Pattern('(analy|diagno|^ba|(p)arenthe|(p)rogno|(s)ynop|(t)he)ses$'), 'PPLShipping\\1\\2sis'));
        ...
        (yield new Transformation(new Pattern('(p)eople$'), 'PPLShipping\\1\\2erson'));
        (yield new Transformation(new Pattern('(m)en$'), '\\1an'));
        (yield new Transformation(new Pattern('(c)hildren$'), 'PPLShipping\\1\\2hild'));
        (yield new Transformation(new Pattern('(f)eet$'), '\\1oot'));
        (yield new Transformation(new Pattern('(n)ews$'), 'PPLShipping\\1\\2ews'));
    ...
    {
        (yield new Transformation(new Pattern('(s)tatus$'), 'PPLShipping\\1\\2tatuses'));
        (yield new Transformation(new Pattern('(quiz)$'), '\\1zes'));
        (yield new Transformation(new Pattern('^(ox)$'), 'PPLShipping\\1\\2en'));
        ...
        (yield new Transformation(new Pattern('(?:([^f])fe|([lr])f)$'), 'PPLShipping\\1\\2ves'));
        ...
        (yield new Transformation(new Pattern('(buffal|her|potat|tomat|volcan)o$'), 'PPLShipping\\1\\2oes'));
