...
use PPLShipping\Safe\Exceptions\YazException;
/**
...
{
    \error_clear_last();
    $result = \PPLShipping\yaz_ccl_parse($id, $query, $result);
    if ($result === \false) {
...
{
    \error_clear_last();
    $result = \PPLShipping\yaz_close($id);
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
}
...
function yaz_connect(string $zurl, $options = null)
{
    \error_clear_last();
    if ($options !== null) {
        $result = \PPLShipping\yaz_connect($zurl, $options);
    } else {
        $result = \PPLShipping\yaz_connect($zurl);
    }
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
...
{
    \error_clear_last();
    $result = \PPLShipping\yaz_database($id, $databases);
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \PPLShipping\yaz_element($id, $elementset);
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \PPLShipping\yaz_present($id);
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \PPLShipping\yaz_search($id, $type, $query);
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
}
...
{
    \error_clear_last();
    $result = \PPLShipping\yaz_wait($options);
    if ($result === \false) {
        throw YazException::createFromPhpError();
    }
    return $result;
